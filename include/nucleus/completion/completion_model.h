...
// only the flag name completes). This carries no shell syntax whatsoever -- no
// quoting, no word-break handling, no escaping. Those concerns belong to the
// per-shell emitter, never to this model or the generator that builds it.
