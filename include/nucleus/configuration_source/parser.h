#ifndef HPP_GUARD_NUCLEUS_CONFIGURATION_SOURCE_PARSER_H
#define HPP_GUARD_NUCLEUS_CONFIGURATION_SOURCE_PARSER_H
...
// capabilities and produces a configuration_source_batch -- no inheritance, no virtuals. This
...
concept Parser = requires(T parser) {
    ...
    { parser.pull() } -> std::convertible_to<configuration_source_result>;
};
